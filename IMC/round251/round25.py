...
class TradingState(object):
  ...
  def __init__(self,
      ...
      order_depths: Dict[Symbol, OrderDepth], # All buy/sell orders each market participant has submitted.
      own_trades: Dict[Symbol, List[Trade]], # Trades done since the last TradingState came in.
      market_trades: Dict[Symbol, List[Trade]], # Trades other market participants have done since the last TradingState came in.
      position: Dict[Product, Position], # List of long/short positions the trader holds per product.
